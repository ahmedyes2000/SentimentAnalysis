...
| Word Representation | Tokenizer          | Classifier          | Subjectivity | PL04   | IMDB    | 
|---------------------|--------------------|---------------------|--------------|--------|---------| 
| Doc2Vec             | Simple Tokenizer   | KNN                 |              |        |         | 
| Doc2Vec             | Advanced Tokenizer | KNN                 | 0.7495       | 0.6875 | 0.84884 | 
| Doc2Vec             | Simple Tokenizer   | Logistic Regression |              |        |         | 
| Doc2Vec             | Advanced Tokenizer | Logistic Regression | 0.8515       | 0.815  |         | 
| Doc2Vec             | Simple Tokenizer   | AdaBoost            |              |        |         | 
| Doc2Vec             | Advanced Tokenizer | AdaBoost            | 0.818        | 0.76   | 0.84696 | 
| Doc2Vec             | Simple Tokenizer   | Bagging             |              |        |         | 
| Doc2Vec             | Advanced Tokenizer | Bagging             | 0.787        | 0.8    |         | 
| Doc2Vec             | Simple Tokenizer   | Decision Trees      |              |        |         | 
| Doc2Vec             | Advanced Tokenizer | Decision Trees      | 0.6215       | 0.6775 |         | 
| Doc2Vec             | Simple Tokenizer   | Random Forests      |              |        |         | 
| Doc2Vec             | Advanced Tokenizer | Random Forests      | 0.6975       | 0.65   |         | 
