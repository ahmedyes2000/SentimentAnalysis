...
gensim_w2v=[0, 0, 0.877622378, 0.872127872, 0.863136863, 0.875624376, 0.825174825, 0.875124875];
gensim_d2v=[0, 0, 0.818, 0.787, 0.6975, 0.7495, 0.6215, 0.8515];
...
word2vec=[0.58,0.48,0.537,0.53,0.515,0.54,0.5,0.51]
bigrams=[0.58,0.5,0.54,0.53,0.51,0.6,0.53,0.57]
gensim_w2v=[0, 0, 0.8375, 0.7925, 0.7225, 0.72, 0.66, 0.855];
gensim_d2v=[0, 0, 0.76, 0.8, 0.65, 0.6875, 0.6775, 0.815];
